...
summarise(MeanAge = mean(age, na.rm = TRUE), 
          sdAge = sprintf ("%.2f", sd(age, na.rm = TRUE)),
          MeanWatt_4mmol = mean (watt_4mmol, na.rm = TRUE),
